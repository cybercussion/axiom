...
3. **docs/auth-readme.md** — runtime config contract, worker contract for refresh rejection, guard example, storage keys, downstream pull notes (scobot/tender/ev/daystrom deltas).
